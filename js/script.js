...
eloadok = ["Red Hot Chili Peppers", "Guns N' Roses", "David Bowie", "Michael Jackson", "Gorillaz", "Amy Winehouse", "Outkast", "Juice WRLD", "Wu-Tang Clan", "Burzum", "The Prodigy", "Miles Davis"];
...
function showReviewModal(index) {
    ...
    reviewModal.show()
    document.getElementById("albumID").innerText = index;
}
